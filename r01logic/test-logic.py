...
if AND(A, B).truthValue([]) == False and AND(A, B).truthValue(["A"]) == False and AND(A, B).truthValue(
        ["B"]) == False and AND(A, B).truthValue(["A", "B"]) == True:
    print("truthValue for AND seems to work OK!")
else:
    print("FAIL: truthValue for AND!")

if OR(A, B).truthValue([]) == False and OR(A, B).truthValue(["A"]) == True and OR(A, B).truthValue(
        ["B"]) == True and OR(A, B).truthValue(["A", "B"]) == True:
...
# for e in satisfiable(AND(AND(A,B),C)):
#     print(type(e))
...
# if f1 has 0 model (unsatisfiable), then the logic consequence f1|=f2 holds for whatever f2
if logicalConsequence(AND(EQVI(A, NOT(B)), EQVI(B, A)), C):
    print('Test 12 OK')
else:
    print("Test 12 FAILS")

# if f1 has 0 model (unsatisfiable), then f1|=f2 holds for whatever f2
if logicalConsequence(AND(A, NOT(A)), AND(A, NOT(A))):
    print('Test 13 OK')
else:
    print('Test 13 FAILS')

# if f2 is valid, then the logic consequence f1|=f2 holds for whatever f1
if logicalConsequence(C, OR(A, NOT(A))):
    print('Test 14 OK')
else:
    print('Test 14 FAILS')

# if f2 is unsatisfiable and f1 has a model, then the f1|=f2 does not hold:
if not logicalConsequence(C, AND(A, NOT(A))):
    print('Test 15 OK')
else:
    print('Test 15 FAILS')

if logicalEquivalence(A, A):
    print('Test logical equivalence passed')
else:
    print('Test logical equivalence failed')

if logicalEquivalence(A, IMPL(OR(B, NOT(B)), A)):
    print('Exercise logical-equivalence-quiz option 1 True')
else:
    print('Exercise logical-equivalence-quiz option 1 False')

if logicalEquivalence(AND(A, IMPL(A, B)), B):
    print('Exercise logical-equivalence-quiz option 2 True')
else:
    print('Exercise logical-equivalence-quiz option 2 False')

if logicalEquivalence(AND(AND(C, A), B), AND(AND(A, B), C)):
    print('Exercise logical-equivalence-quiz option 3 True')
else:
    print('Exercise logical-equivalence-quiz option 3 False')

if logicalEquivalence(IMPL(A, IMPL(A, A)), OR(B, NOT(B))):
    print('Exercise logical-equivalence-quiz option 4 True')
else:
    print('Exercise logical-equivalence-quiz option 4 False')

if logicalEquivalence(IMPL(A, B), IMPL(NOT(A), NOT(B))):
    print('Exercise logical-equivalence-quiz option 5 True')
else:
    print('Exercise logical-equivalence-quiz option 5 False')


if logicalEquivalence(IMPL(A, A), A):
    print('Exercise 2.6 option 1 True')
else:
    print('Exercise 2.6 option 1 False')

if logicalEquivalence(IMPL(A, IMPL(A, A)), TRUE()):
    print('Exercise 2.6 option 2 True')
else:
    print('Exercise 2.6 option 2 False')

if logicalEquivalence(IMPL(B, IMPL(A, A)), TRUE()):
    print('Exercise 2.6 option 3 True')
else:
    print('Exercise 2.6 option 3 False')

if logicalEquivalence(IMPL(A, IMPL(B, C)), IMPL(AND(A, B), C)):
    print('Exercise 2.6 option 4 True')
else:
    print('Exercise 2.6 option 4 False')

if logicalEquivalence(IMPL(IMPL(A, A), A), A):
    print('Exercise 2.6 option 5 True')
else:
    print('Exercise 2.6 option 5 False')


if logicalEquivalence(OR(A, AND(B,C)), AND(OR(A, B), OR(A, C))):
    print('Test 1 OK')
else:
    print('Test 1 not OK')

if logicalEquivalence(chainAND([OR(FALSE(), AND(A, TRUE())), IMPL(B, FALSE()), OR(C, AND(FALSE(),D))]), chainAND([A, NOT(B), C])):
    print('Test 2 OK')
else:
    print('Test 2 not OK')

if logicalEquivalence(OR(C, AND(FALSE(),D)), AND(OR(C,FALSE()),OR(C,D))):
    print('Test 3 OK')
else:
    print('Test 3 not OK')

if logicalEquivalence(AND(C, OR(C,D)), OR(C, AND(C,D))):
    print('Test 4 OK')
else:
    print('Test 4 not OK')

if logicalEquivalence(AND(C, OR(C,D)), C):
    print('Test 5 OK')
else:
    print('Test 5 not OK')

if logicalEquivalence(AND(IMPL(A,D),IMPL(NOT(A),C)), OR(OR(AND(D,A), AND(NOT(A),C)),AND(D,C))):
    print('Test 6 OK')
else:
    print('Test 6 not OK')
