...
class GridAction:
    ...
    def __repr__(self):
        return f"GridAction({self._name}, {self._n_rows}, {self._n_cols}, {self._dr}, {self._dc})"


class ManhattanMoves:
    """
    Class representing the set of Manhattan moves: north, south, east, and west;
    plus remain in place.
    """
    ...
    def __init__(self, n_rows, n_cols):
        ...
        self.remain = GridAction("Remain", self.n_rows, self.n_cols, 0, 0)
    ...
    def all_actions(self):
        ...
        """
        return {self.north, self.south, self.east, self.west, self.remain}

    def left90(self, a):
        """
        Get the counter clockwise action of a movement action `a`.
        (The remain action is invariant.)
    ...
    def right90(self, a):
        """
        Get the clockwise action of a movement action `a`.
        (The remain action is invariant.)
